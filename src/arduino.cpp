...
public:
  ...
  map<string, string> info() override {
    return {
        ...
        {"timeout", to_string(_params["connection_timeout"].get<unsigned>())}};
  };
...
int main(int argc, char const *argv[]) {
  ...
  while (running) {
    ...
    } else if (rt == return_type::warning) {
      cerr << "Warning: " << plugin.error() << endl;
    } else if (rt == return_type::critical) {
      cerr << "Critical error: " << plugin.error() << endl;
      break;
    }
